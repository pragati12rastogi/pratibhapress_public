...
@section('title', __('accounting/scenario.list'))
...
@section('breadcrumb')
    ...
    <li><a href="#"><i class=""></i>{{__('accounting/scenario.list')}}</a></li> 
@endsection
@section('css')
<style>
   .content{
  ...
  <script>
    ...
    $(document).ready(function() {
      dataTable = $('#asn_table').DataTable({
          ...
          "aaSorting":[],
          "responsive": true,
          "ajax": "/accounting/scenario/list/api",
          "columns": [
              { "data": "id" }, 
              { "data": "name" }, 
              {
                  ...
                  {
                    return "<a href='/accounting/scenario/update/"+data+"'><button class='btn btn-primary btn-xs'> {{__('accounting/group.update')}} </button></a> &nbsp;" + 
                    '<a href="/accounting/scenario/view/'+data+'"><button class="btn btn-success btn-xs"> {{__("accounting/group.view")}} </button></a>' 
                    ;
                  }
              }
            ],
    ...
    <section class="content">
        ...
        <div class="box">
                ...
                <div class="box-body">
                    ...
                    <thead>
                    <tr>
                      <th>{{__('accounting/scenario.id')}}</th>
                      <th>{{__('accounting/scenario.name')}}</th>
