...
@section('main_section')
    <section class="content">
        ...
        @endif
        <form method="POST" action="/accounting/vouchertype/create" id="voucher_type_form">
                @csrf
                    ...
                    <div class="container-fluid wdt">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="VoucherName" class="form-control input-css VoucherName" id="VoucherName">
                            </div>
                            <div class="col-md-6">
                                <label for="VoucherAlias">{{__('accounting/voucher.voucheralias')}}</label>
                                <input type="text" name="VoucherAlias" class="form-control input-css VoucherAlias" id="VoucherAlias">
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class=" form-control input-css VoucherAbbr" id="VoucherAbbr" name="VoucherAbbr">
            ...
            <div id="VoucherLayout" style="display:none">
                <div class="box-header with-border">
                    <div class="box box-default"><br>
                        <div class="container-fluid wdt">
                            <div class="row">
                                {{-- container for section data 1 --}}
                                <div class="col-md-4" id="VoucherLayout1">
                                    <h2 class="box-title" style="font-size: 20px;margin-left:20px">{{__("accounting/voucher.GeneralSetting")}}</h2><br><br><br>
                                </div>
                                {{-- container for section data 2 --}}
                                <div class="col-md-4" id="VoucherLayout2">
                                    <h2 class="box-title" style="font-size: 20px;margin-left:20px">{{__("accounting/voucher.PrintSetting")}}</h2><br><br><br>
                                </div>
                                {{-- container for section data 3 --}}
                                <div class="col-md-4" id="VoucherLayout3">
                                    <h2 class="box-title" style="font-size: 20px;margin-left:20px">{{__("accounting/voucher.AdditionalSetting")}}</h2><br><br><br>
                                </div>
                            </div>
                        </div>
