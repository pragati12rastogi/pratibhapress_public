...
@section('title', __('accounting/ledger.list'))
  ...
  <script>
    ...
    $(document).ready(function() {
      dataTable = $('#asn_table').DataTable({
          ...
          "aaSorting":[],
          "responsive": true,
          "ajax": "/accounting/ledger/list/api",
          "columns": [
              { "data": "id" }, 
              { "data": "name" }, 
              { "data": "alias" },
              { "data": "parent" },  
              {
                  ...
                  {
                    return "<a href='/accounting/ledger/update/"+data+"'><button class='btn btn-primary btn-xs'> {{__('accounting/group.update')}} </button></a> &nbsp;" + 
                    '<a href="/accounting/ledger/view/'+data+'"><button class="btn btn-success btn-xs"> {{__("accounting/group.view")}} </button></a>' 
                    ;
                  }
              }
            ],
    ...
    <section class="content">
        ...
        <div class="box">
                ...
                <div class="box-body">
                    ...
                    <thead>
                    <tr>
                      <th>{{__('accounting/ledger.id')}}</th>
                      <th>{{__('accounting/ledger.name')}}</th>
                      <th>{{__('accounting/ledger.alias')}}</th>
                      <th> {{__('accounting/ledger.ledger_under')}}</th>
