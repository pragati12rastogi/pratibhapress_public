...
@section('title', 'Pending Job Card Creation')

@section('user', Auth::user()->name)

@section('breadcrumb')

    <li><a href="#"><i class=""></i>Pending Job Card Creation </a></li> 
@endsection
@section('css')
<style>
   .content{
  ...
  <script>
    ...
    $(document).ready(function() {
      dataTable = $('#table').DataTable({
          ...
          "aaSorting":[],
          "responsive": true,
          "ajax": "/report/pending/job/card/list/api",
          "columns": [
            {"data":"io_number"},
            {"data":"name"},
            {"data":"created_time"},
...
@section('main_section')
    <section class="content">
        ...
        <div class="box">
                ...
                <div class="box-body">
                    @section('titlebutton')
                    <a href="/export/data/pendingjobcard" ><button class="btn btn-primary">Export Job Card</button></a> 
                    @endsection
