...
<li><a href="{{url('/master/machine/list')}}"><i class=""></i>Machine List</a></li>
    <li><a href="#"><i class=""></i>Create Machine</a></li>
...
@section('main_section')
    <section class="content">
       ...
       <form action="/master/machine/create" method="POST" id="machineform" enctype="multipart/form-data">
        @csrf
       ...
       <div class="box box-header">
        ...
        <div class="row" >
                <div class="col-md-6 {{ $errors->has('m_brand') ? ' has-error' : ''}}">
                    ...
                    <input type="text" name="m_brand" id="m_brand" class="m_brand input-css" maxlength="50" required=''>
                ...
                <div class="col-md-6 {{ $errors->has('m_size') ? ' has-error' : ''}}">
                    ...
                    <input type="text" name="m_size" id="m_size" class="m_size input-css" maxlength="50" required=''>
        ...
        <div class="row" >
                <div class="col-md-6 {{ $errors->has('m_date') ? ' has-error' : ''}}">
                    ...
                    <input type="text" name="m_date" id="m_date" class=" m_date input-css" required=''>
                ...
                <div class="col-md-6 {{ $errors->has('m_bill_no') ? ' has-error' : ''}}">
                    ...
                    <input type="text" name="m_bill_no" id="m_bill_no" class="m_bill_no input-css" required=''>
