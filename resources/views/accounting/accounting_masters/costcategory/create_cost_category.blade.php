...
@section('title', __('accounting/costcategory.create title'))

{{-- TODO: fetch from auth --}}
@section('user', Auth::user()->name)

@section('breadcrumb')
<li><a href="#"><i class="">{{__('accounting/costcategory.create title')}}</i></a></li>
 @endsection
@section('css')
<style>
            ...
            <div class="box-header with-border">
                <div class='box box-default'>  <br>
                    <div class="container-fluid wdt">
                        <form method="POST" action="/accounting/costcategory/create" id="cost_category_form">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
