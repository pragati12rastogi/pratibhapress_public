...
@section('title', 'Delegation Score Summary')
...
@section('breadcrumb')
    ...
    <li><a href="#"><i class=""></i>Delegation Score Summary</a></li> 
@endsection
@section('css')
<style>
   .content{
    ...
    $(document).ready(function() {
      ...
      dataTable = $('#table').DataTable({
          ...
          "columns": [
              ...
              {"data":"green", "render": function(data,type,full,meta)
                  {   
                      if(data == ""|| data == null){
                        return '';
                      }else{
              ...
              {"data":"yellow", "render": function(data,type,full,meta)
                  {   
              ...
              {"data":"red", "render": function(data,type,full,meta)
              {   
