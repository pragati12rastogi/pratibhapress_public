...
@section('title', __('vendor/vendor.title'))
...
@section('main_section')
    <section class="content">
            ...
            <form method="POST" action="/vendor/create" id="vendor">
                   @csrf
                   @php
                   $flag=0;
                   $start=0;
                   ...
                   <div class="box-header with-border">
                    ...
                    <div class="row">
                        <div class="col-md-6 {{ $errors->has('lev1') ? 'has-error' : ''}}">
                            ...
                            <option value="{{$key->id}}" {{$errors->has('lev1') ? '' : ($flag==1?'':(session('lastformdata')['lev1']==$key->user_name? 'selected="selected"':''))}}>{{$key->user_name}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6 {{ $errors->has('lev2') ? 'has-error' : ''}}">
                            ...
                            <option value="{{$key->id}}" {{$errors->has('lev2') ? '' : ($flag==1?'':(session('lastformdata')['lev2']==$key->user_name? 'selected="selected"':''))}}>{{$key->user_name}}</option>
                                @endforeach
                ...
                <div class="row">
                    <div class="col-md-4 {{ $errors->has('acc_name') ? 'has-error' : ''}}">
                            ...
                            <input type="text" name="acc_name" id="" class="input-css acc_name" required>
                    ...
                    <div class="col-md-4 {{ $errors->has('acc_number') ? 'has-error' : ''}}">
                            ...
                            <input type="number" min="0" step="none" name="acc_number" id="" class="input-css acc_number" required>
                    ...
                    <div class="col-md-4 {{ $errors->has('acc_ifsc') ? 'has-error' : ''}}">
                            ...
                            <input type="text" name="acc_ifsc" id="" class="input-css acc_ifsc" required>
