...
@section('title', 'Plate By Party Creation Summary')
...
<script>
  ...
  var status="Open";
    dataTable = $('#jobcard_list_table').DataTable({
      ...
      "processing": true,
        "serverSide": true,
        "ajax" : "/production/PlateByParty/creation/api",  
        "aaSorting": [],
        "responsive": true,
        "columns": [
          ...
          { "data": "baking_date" },
          { "data": "no_plates" },
          { "data": "prod_plate_size" },
          { "data": "elem_plate_size" },
