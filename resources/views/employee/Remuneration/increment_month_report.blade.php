...
@section('title', 'Month Wise Increment Report ')
...
@section('breadcrumb')
    ...
    <li><a href="#"><i class=""></i>Month Wise Increment Report </a></li> 
@endsection
@section('css')
<style>
   .content{
    ...
    function emp_wise(){
      ...
      if($('#emp_name').val() != ""){
        ...
        dataTable = $('#history').DataTable({
          ...
          "responsive": true,
          "ajax": {
            "url":"/increment/month/wise/report/api",
            "datatype": "json",
            "data": function (data) {
                var month = $('#month').val();
                var year = $('#year').val();
                ...
                <div class="box-body">
                    @section('titlebutton')
                      ...
                      @endsection
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label for="">Month <sup>*</sup></label>
                                <input name="month" class=" input-css month" id="month" onchange="emp_wise()" autocomplete="off">
                            </div>
                            <div class="col-md-6">
                                <label for="">Year <sup>*</sup></label>
                                <input name="year" class="input-css year" id="year" onchange="emp_wise()" autocomplete="off">
                            </div>
                          </div><br><br>
