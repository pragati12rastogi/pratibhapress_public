...
@section('title', 'Salary A Summary')

@section('breadcrumb')

    <li><a href="#"><i class=""></i>Salary A Summary</a></li> 
@endsection
@section('css')
<style>
   .content{
...
$("#js-msg-error").hide();
    ...
    function create_datatable(){
      ...
      dataTable = $('#att_table').DataTable({
          ...
          "responsive": true,
          "ajax": {
            "url": "/employee/salary/list/a/api",
            "datatype": "json",
                "data": function (data) {
    ...
    function geturl(){
        ...
        var month = $('#month').val();
       $("#export_anchor").attr("href", '/export/data/salary/a?emp='+emp+'&month='+month);
    ...
    function SalaryPayment(el){
      ...
      $.ajax({  
                url:"/employee/salary/list/a/payment/details/"+id+'/'+type,  
                method:"get",  
                success:function(data){
                  ...
                  if (data.msg == 'error') {
                      ...
                      if(data) {
                        ...
                        $('#payment_mode option:eq(0)').attr('selected','selected');
    ...
    function BtnSubmit(){
      ...
      var id = $("#id").val();
        $('#ajax_loader_div').css('display','block');
        $.ajax({
          url: "/employee/salary/list/a/payment",
          data: {
            'id': id,
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-1 pull-right">
                        <a href="/export/data/salary/a" id="export_anchor">
