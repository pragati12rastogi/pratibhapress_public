...
@extends($layout)
@section('title', __('taxinvoice.mytitle'))

{{-- TODO: fetch from auth --}}
@section('user', Auth::user()->name)

@section('breadcrumb')
<li><a href="#"><i class="">{{__('taxinvoice.mytitle')}}</i></a></li>
@endsection
...
<div class="box-header with-border">
        <div class='box box-default'>
            <div class="container-fluid">
                <h2>{{$tax_detail[0]['invoice_number']}}</h2>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                                <table class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            <th colspan="3">Tax invoice Date:</th>
                                            <td>
                                ...
                                <table class="table table-bordered table-striped">
                                        <tr style="width:100%;">
                                            ...
                                            <tr>
                                                ...
                                                <p>{{wordwrap($tax_detail[0]['con_address'], 70, "\n", true)}} , {{$tax_detail[0]['con_cities']}} , {{$tax_detail[0]['con_states']}},{{$tax_detail[0]['con_country']}} , {{$tax_detail[0]['con_pincode']}}<br>
                                                </p>
                                              
                                                </td>
                                                <td colspan="6">
                                                        <b>{{$tax_detail[0]['partyname']}}</b><br>
                                                        <p>{{wordwrap($tax_detail[0]['party_address'], 70, "\n", true)}} , {{$tax_detail[0]['city']}} , {{$tax_detail[0]['state']}},{{$tax_detail[0]['country']}} , {{$tax_detail[0]['pincode']}}<br>
                                                        </p>
