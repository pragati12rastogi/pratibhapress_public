...
@section('title', 'Salary A Calculation')
...
var month=date.getMonth(); //get month
    ...
    function getData(counter){
        ...
        var total_salaryA=result.employee.total_salaryA;
        var overtime_salaryA=result.employee.overtime_salaryA;
       ...
       console.log("ad = "+ad);
        ...
        $('.tot_sal').text(total_salaryA);
        if (isNaN(overtime_salaryA)) overtime_salaryA = 0; 
        $('.ot_A').text(overtime_salaryA);
       ...
       if(flag==0 && mons[0]!=month){
        ...
        //leave deduction 
        var leave_ded=(parseFloat(total_salaryA)/parseFloat(total_days))*parseFloat(leave_adjusted);
        ...
        var salary_ctc=(parseFloat(total_salaryA)/parseFloat(total_days))*parseFloat(effective_present);
        ...
        var half_day=(parseFloat(total_salaryA)/parseFloat(total_days))*parseFloat(hd);
        $('.hd_deduction').text(half_day.toFixed(2));
        $('.hd_deduction').val(half_day.toFixed(2));
        //ot calculated

        var ot_ctc=parseFloat(parseFloat(overtime_salaryA)/parseFloat(total_days)/360)*ot_late;
        ...
        var other_deduction=((parseFloat(overtime_salaryA)/parseFloat(total_days/360))*parseFloat(other_time_deduction));
        ...
        var salary=parseFloat(salary_ctc)+parseFloat(ot_ctc)-parseFloat(pf_ded)-parseFloat(esi_ded)-parseFloat(ad)-parseFloat(other_deduction)-parseFloat(half_day);
...
@section('main_section')
    <section class="content">
        ...
        <!-- Default box -->
        <form action="/salaryA/create" method="post">
        @csrf
                ...
                <input type="hidden" name="month" class="mon">
                        <div class="col-md-12">
                                <table class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            <th colspan="3">Total Salary A:</th>
                                            <td ><label for="" class="tot_sal"></td>
                                            
                                            <th colspan="3">OT on salary A:</th>
