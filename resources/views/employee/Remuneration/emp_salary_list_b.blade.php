...
@section('title', 'Salary B Summary')

@section('breadcrumb')

    <li><a href="#"><i class=""></i>Salary B Summary</a></li> 
@endsection
@section('css')
<style>
   .content{
...
$("#js-msg-error").hide();
    ...
    function create_datatable(){
      ...
      dataTable = $('#att_table').DataTable({
          ...
          "responsive": true,
          "ajax": {
            "url": "/employee/salary/list/b/api",
            "datatype": "json",
                "data": function (data) {
    ...
    function geturl(){
        ...
        var month = $('#month').val();
       $("#export_anchor").attr("href", '/export/data/salary/b?emp='+emp+'&month='+month);
     ...
     function SalaryPayment(el){
      ...
      $.ajax({  
                url:"/employee/salary/list/b/payment/details/"+id+'/'+type,  
                method:"get",  
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-1 pull-right">
                        <a href="/export/data/salary/b" id="export_anchor">
