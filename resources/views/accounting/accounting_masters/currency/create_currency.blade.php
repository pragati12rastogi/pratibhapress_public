...
@section('title', __('accounting/currency.create title'))

{{-- TODO: fetch from auth --}}
@section('user', Auth::user()->name)

@section('breadcrumb')
<li><a href="#"><i class="">{{__('accounting/currency.create title')}}</i></a></li>
 @endsection
@section('css')
<style>
        ...
        <!-- Default box -->
            ...
            <div class="box-header with-border">
                <div class='box box-default'>  <br>
                    <h2 class="box-title" style="font-size: 28px;margin-left:20px">{{__('accounting/currency.create title')}}</h2><br><br><br>
                    <div class="container-fluid wdt">
                        <form method="POST" action="/accounting/currency/create" id="currency_form">
                            @csrf
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <input type="text" name="symbol" id="symbol" class="input-css form-control symbol validtxt">
                                </div>
                                <div class="col-md-6">
                                    <label for="">{{__('accounting/currency.formal name')}}</label>
                                    <input type="text" name="formal_name" id="formal_name" class="input-css form-control formal_name validtxt">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="">{{__('accounting/currency.decimal places')}}</label>
                                    <input type="text" name="decimal_places" id="decimal_places" class="input-css form-control decimal_places validtxt">
                                </div>
                                <div class="col-md-6">
                                    <label for="">{{__('accounting/currency.amt in million')}}</label>
                                    <select  name="amt_in_million" id="amt_in_million" class="input-css form-control select amt_in_million validopt">                                        <option value="0" selected="selected">No</option>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="decimal_position_symbol" id="decimal_position_symbol" class="input-css form-control decimal_position_symbol validtxt">
                                </div>
                                <div class="col-md-6">
                                    <label for="">{{__('accounting/currency.decimal places amount')}}</label>
                                    <input type="text" name="decimal_places_amount" id="decimal_places_amount" class="input-css form-control decimal_places_amount validtxt">
                                </div>
                            </div>
