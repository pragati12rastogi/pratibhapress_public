...
@section('title', 'Binding Bill Report')
...
@section('breadcrumb')
    ...
    <li><a href="#"><i class=""></i>Binding Bill</a></li> 
@endsection
@section('css')
...
<script src="/js/dataTables.responsive.js"></script>
  ...
  var dataTable;
    ...
    // Data Tables
    function fetchingDataForTable(bind_id,io_id){
    ...
    var last_tr = null ;
     ...
     hr=hr.split(",");
      dataTable = $('#asn_table').DataTable({
          ...
          "aaSorting":[],
          "responsive": true,
          "ajax": "/binding/bills/report/binder/api/"+bind_id+"/"+io_id,
    ...
    var last_tr = null ;
      ...
      $('#select_do').on('select2:select', function (e) {
          ...
          $.ajax({
              url: "/binding/bills/getbinder/" + val,
              type: "GET",
              success:function(result) {
                $("#select_wa").empty();
                    $("#select_wa").append('<option disabled selected>Select Binder</option>');
                    for(var i=0;i<result.length;i++){
                        $("#select_wa").append('<option value="'+result[i].id+'">'+result[i].name+'</option>');
                    }
...
$('#select_wa').on('select2:select', function (e) {
    ...
    if(dataTable)
      dataTable.destroy();
      fetchingDataForTable(select_data.id,vals);
});
    ...
    <section class="content">
        ...
        <div class="box">
                ...
                <div class="box-header">
                  <h3 class="box-title">Select Internal Order to List Binder</h3>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <select id="select_wa" class="form-control select2"  data-placeholder="" style="width: 100%;" >
                                <option value="-1">Select Binder</option>
