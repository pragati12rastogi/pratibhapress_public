  ...
  <script>
    ...
    $(document).ready(function() {
      dataTable = $('#table').DataTable({
          ...
          "aaSorting":[],
          "responsive": true,
          "ajax": "/master/assets/assign/employee/list/api",
          "columns": [
              {"data":"employee"},
              {"data":"asset_code"},
              {"data":"category_name"},
                  ...
                  },},
              {
                  ...
                  "data":"aa_id", "render": function(data,type,full,meta)
                  {
                    if(full.status == null || full.status == ""){
                      return "<a href='/asset/return/"+data+"' target='_blank'><button class='btn btn-primary btn-xs'> Return </button></a> &nbsp;"
                      ;
                  }else{
                    return"";
                  }
...
@section('main_section')
    <section class="content">
        ...
        <div class="box">
                ...
                <div class="box-body">
                    @section('titlebutton')
                    <a href="{{url('/master/assets/assign/employee')}}"><button class="btn btn-primary">Assign Assets</button></a>
                      @endsection
