...
@section('title', __('gatepass.title3'))
            ...
            <div class="box-header with-border">
                <div class='box box-default'>  <br>
                    ...
                    <div class="container-fluid wdt">
                        <form  action="/gatepass/material/update/form/{{$detail['id']}}" method="post" id="gatepass_form">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                                ...
                                                <select value="{{ old('challan_type') }}" name="challan_type"  class="select2 input-css challan_type" id="challan_type">
                                                   ...
                                                   <option value="PPML/DCN/" {{$detail['challan_type']=='PPML/DCN/'? 'selected=selected':''}}>PPML/DCN/</option>
                                                   <option value="PPML/IDC/" {{$detail['challan_type']=='PPML/IDC/' ? 'selected=selected':''}}>PPML/IDC/</option>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="mode" class="select2 input-css mode" id="mode">
                                                   ...
                                                   @foreach ($delivery as $item)
                                                    ...
                                                    <option value="{{$item['id']}}" {{$item['id']==$detail['mode_id'] ? 'selected=selected':''}}>{{$item['name']}}</option>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select value="{{ old('carrier') }}" name="carrier"  class="select2 input-css carrier" id="carrier">
                                            ...
                                            <option value="{{$item['id']}}" {{$item['id']==$detail['carrier_id'] ? 'selected=selected':''}}>{{$item['courier_name']."-(".$item['name'].")"}}</option>
                                               @endforeach
                                        </select>
